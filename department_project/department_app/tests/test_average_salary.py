...
class AverageSalaryTestCase(TestCase):
    ...
    def test_count(self):
        ...
        response_department = DepartmentViewSet.as_view({'post': 'create'})(requests_department)
        ...
        response_employee1 = EmployeeViewSet.as_view({'post': 'create'})(requests_employee1)
        requests_employee2 = self.factory.post('/api/v1/employee/', {'name': 'TEST TEST',
                                                                     'date_of_birthday': '1999-10-09',
                                                                     'salary': 968.00,
                                                                     'department': id_department}, format='json')
        response_employee2 = EmployeeViewSet.as_view({'post': 'create'})(requests_employee2)
